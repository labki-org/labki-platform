...
// Forum-style discussion topics on top of DiscussionTools. The full
// implementation (SMW properties, ParserAfterParse annotation,
// post-save DT-stash job, watchlist fanout, DT auto-subscribe
// timezone-bug workaround, frontend assets) lives in its own
// extension as of the cutover from the inline block previously here.
// See https://github.com/labki-org/DiscussionForum#readme.
