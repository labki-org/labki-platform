...
> [!WARNING]
> **Never edit `/var/www/html/LocalSettings.php`!** This file is auto-generated by the entrypoint and will be overwritten on every container restart. All user modifications belong in `/mw-config/LocalSettings.user.php`.
